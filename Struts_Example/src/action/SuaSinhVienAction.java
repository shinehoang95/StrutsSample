...
public class SuaSinhVienAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if("submit".equals(sinhVienForm.getSubmit())){					//nhan nut Xac nhan o trang Them sinh vien
			...
			String diaChi = sinhVienForm.getDiaChi();
			String sdt = sinhVienForm.getSdt();
			sinhVienBO.suaSinhVien(msv, hoTen, gioiTinh, maKhoa,diaChi,sdt);
			...
			sinhVienForm.setDiaChi(sinhVien.getDiaChi());
			sinhVienForm.setSdt(sinhVien.getSdt());
